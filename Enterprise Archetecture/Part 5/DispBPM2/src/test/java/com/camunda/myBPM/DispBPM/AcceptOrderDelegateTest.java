...
public class AcceptOrderDelegateTest {
	...
	public void verifyThatTheDelegateSetsVariable() {
		...
		AcceptOrderDelegate delegate = new AcceptOrderDelegate();
		...
		verify(mockExecution, times(1)).setVariable(eq("OrderAccepted"), any(Boolean.class));
